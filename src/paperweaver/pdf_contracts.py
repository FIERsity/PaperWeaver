...
def _validate_policy(policy: dict[str, Any]) -> None:
    expected = {
        ...
        "column_gap_ratio",
        "column_channel_min_gap_points",
        "rule_thickness_pt",
        "math_symbol_font_glyph_ratio",
        "math_fragment_min_chars",
        "math_fragment_min_share",
        "math_fragment_body_font_share",
    ...
    limits = {
        ...
        "column_channel_min_gap_points": (1.0, 200.0),
        "min_repeated_artifact_pages": (1, 100),
        "table_region_gap_pt": (1.0, 1000.0),
        "math_symbol_font_glyph_ratio": (0.0, 1.0),
        "math_fragment_min_chars": (0, 100),
        "math_fragment_min_share": (0.0, 1.0),
        "math_fragment_body_font_share": (0.0, 1.0),
